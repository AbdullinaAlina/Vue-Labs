...
export const useStore = defineStore('main', {
    state: () => ({
        users: [
            { id: 1, name: "Mark Twen", email: "fianit8@gmail.com", age: 29, address: "New York, USA", Avatar: "/assets/pfp_1.svg" },
            { id: 2, name: "Katherine Johns", email: "katherine.johns@example.com", age: 25, address: "Los Angeles, USA", Avatar: "/assets/pfp_2.svg" },
            { id: 3, name: "Sally Robinson", email: "sally.robinson@example.com", age: 31, address: "Seattle, USA", Avatar: "/assets/pfp_3.svg" },
            { id: 4, name: "Stevie", email: "stevie@example.com", age: 22, address: "Miami, USA", Avatar: "/assets/pfp_4.svg" },
            { id: 5, name: "Jenna Paul", email: "jenna.paul@example.com", age: 28, address: "Chicago, USA", Avatar: "/assets/pfp_5.svg" },
            { id: 6, name: "David King", email: "david.king@example.com", age: 30, address: "Dallas, USA", Avatar: "/assets/pfp_6.svg" },
            { id: 7, name: "Michael Hart", email: "michael.hart@example.com", age: 27, address: "San Francisco, USA", Avatar: "/assets/pfp_7.svg" },
            { id: 8, name: "Olivia George", email: "olivia.george@example.com", age: 24, address: "Boston, USA", Avatar: "/assets/pfp_8.svg" },
            { id: 9, name: "Chris Nolan", email: "chris.nolan@example.com", age: 26, address: "Austin, USA", Avatar: "/assets/pfp_9.svg" },
            { id: 10, name: "Isla Fisher", email: "isla.fisher@example.com", age: 23, address: "Phoenix, USA", Avatar: "/assets/pfp_10.svg" },
            { id: 11, name: "Robert Quinn", email: "robert.quinn@example.com", age: 33, address: "Philadelphia, USA", Avatar: "/assets/pfp_11.svg" },
            { id: 12, name: "Lily Evans", email: "lily.evans@example.com", age: 29, address: "San Diego, USA", Avatar: "/assets/pfp_12.svg" },
            { id: 13, name: "Dylan Brooks", email: "dylan.brooks@example.com", age: 32, address: "Portland, USA", Avatar: "/assets/pfp_13.svg" },
            { id: 14, name: "Sophia Perez", email: "sophia.perez@example.com", age: 21, address: "Las Vegas, USA", Avatar: "/assets/pfp_14.svg" },
            { id: 15, name: "Jacob Lee", email: "jacob.lee@example.com", age: 28, address: "Seattle, USA", Avatar: "/assets/pfp_15.svg" },
            { id: 16, name: "Emily Rose", email: "emily.rose@example.com", age: 30, address: "Atlanta, USA", Avatar: "/assets/pfp_16.svg" },
            { id: 17, name: "Aaron Clark", email: "aaron.clark@example.com", age: 26, address: "Denver, USA", Avatar: "/assets/pfp_17.svg" },
            { id: 18, name: "Grace Wilson", email: "grace.wilson@example.com", age: 27, address: "San Jose, USA", Avatar: "/assets/pfp_18.svg" },
            { id: 19, name: "Ethan Turner", email: "ethan.turner@example.com", age: 24, address: "Orlando, USA", Avatar: "/assets/pfp_19.svg" },
            { id: 20, name: "Mia Carter", email: "mia.carter@example.com", age: 29, address: "Charlotte, USA", Avatar: "/assets/pfp_20.svg" }
        ],
        posts: [
