...
export const useStore = defineStore('main', {
    state: () => ({
        users: [
            { id: 1, name: "Mark Twen", age: 29, address: "New York, USA", Avatar: "/assets/pfp_1.svg" },
            { id: 2, name: "Katherine Johns", age: 25, address: "Los Angeles, USA", Avatar: "/assets/pfp_2.svg" },
            { id: 3, name: "Sally Robinson", age: 31, address: "Seattle, USA", Avatar: "/assets/pfp_3.svg" },
            { id: 4, name: "Stevie", age: 22, address: "Miami, USA", Avatar: "/assets/pfp_4.svg" },
            { id: 5, name: "Jenna Paul", age: 28, address: "Chicago, USA", Avatar: "/assets/pfp_5.svg" },
            { id: 6, name: "David King", age: 30, address: "Dallas, USA", Avatar: "/assets/pfp_6.svg" },
            { id: 7, name: "Michael Hart", age: 27, address: "San Francisco, USA", Avatar: "/assets/pfp_7.svg" },
            { id: 8, name: "Olivia George", age: 24, address: "Boston, USA", Avatar: "/assets/pfp_8.svg" },
            { id: 9, name: "Chris Nolan", age: 26, address: "Austin, USA", Avatar: "/assets/pfp_9.svg" },
            { id: 10, name: "Isla Fisher", age: 23, address: "Phoenix, USA", Avatar: "/assets/pfp_10.svg" },
            { id: 11, name: "Robert Quinn", age: 33, address: "Philadelphia, USA", Avatar: "/assets/pfp_11.svg" },
            { id: 12, name: "Lily Evans", age: 29, address: "San Diego, USA", Avatar: "/assets/pfp_12.svg" },
            { id: 13, name: "Dylan Brooks", age: 32, address: "Portland, USA", Avatar: "/assets/pfp_13.svg" },
            { id: 14, name: "Sophia Perez", age: 21, address: "Las Vegas, USA", Avatar: "/assets/pfp_14.svg" },
            { id: 15, name: "Jacob Lee", age: 28, address: "Seattle, USA", Avatar: "/assets/pfp_15.svg" },
            { id: 16, name: "Emily Rose", age: 30, address: "Atlanta, USA", Avatar: "/assets/pfp_16.svg" },
            { id: 17, name: "Aaron Clark", age: 26, address: "Denver, USA", Avatar: "/assets/pfp_17.svg" },
            { id: 18, name: "Grace Wilson", age: 27, address: "San Jose, USA", Avatar: "/assets/pfp_18.svg" },
            { id: 19, name: "Ethan Turner", age: 24, address: "Orlando, USA", Avatar: "/assets/pfp_19.svg" },
            { id: 20, name: "Mia Carter", age: 29, address: "Charlotte, USA", Avatar: "/assets/pfp_20.svg" }
        ],
        posts: [
